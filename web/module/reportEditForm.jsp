...
<table width="100%">
	...
	<tr>
		...
		<td><c:if test="${archiveExists}">
			<a
				href="${pageContext.request.contextPath}/moduleServlet/jasperReport/jreportDownload?reportId=${jreport.reportId}">${jreport.reportId}.zip</a>&nbsp; &nbsp;
			<input type="submit" name="action"
				value="<spring:message code="jasperReport.reload.parameters"/>">
...
<c:if test="${jreport.reportId != null && archiveExists}">
	<b class="boxHeader"><spring:message
		code="jasperReport.edit.parameters" /></b>
	<table id="parameters" class="box">
		<tr align="left">
			...
			<th><spring:message code="jasperReport.class.mapped" /></th>
...
<input type="submit" name="action"
	value="<spring:message code="jasperReport.save"/>"> <c:if
	test="${jreport.reportId != null}">
	<openmrs:hasPrivilege privilege="Manage Jasper Reports">
			 &nbsp; &nbsp; &nbsp;
			<input type="submit" name="action"
			value="<spring:message code="jasperReport.delete"/>"
