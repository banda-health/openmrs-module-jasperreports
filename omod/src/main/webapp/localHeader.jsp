...
<ul id="menu">
	...
	<openmrs:hasPrivilege privilege="Manage Jasper Reports">
		<li <c:if test="<%= request.getRequestURI().contains(\"jasperreport/view\") %>">class="active"</c:if>>
			<a href="${pageContext.request.contextPath}/module/${pom.parent.artifactId}/jreport.list" class="retired">
